...
- [ ] 1. Add `lockedFromDeletion` field to League model and create Prisma middleware
  - [ ] 1.1 Add `lockedFromDeletion` Boolean field to the League model in `server/prisma/schema.prisma`
  ...
  - [ ] 1.2 Create Prisma middleware for automatic lock on match status transition (`server/src/middleware/league-lock.ts`)
...
- [ ] 2. Implement LeagueDeletionService (`server/src/services/LeagueDeletionService.ts`)
  - [ ] 2.1 Create `LeagueDeletionService` class with `getDeletionPreview` method
  ...
  - [ ] 2.3 Implement `executeLeagueDeletion` method — Stripe refunds step
  ...
  - [ ] 2.5 Implement `executeLeagueDeletion` method — roster balance refunds step
  ...
  - [ ] 2.7 Implement `executeLeagueDeletion` method — rental detachment and event cleanup
...
- [ ] 4. Rewrite league deletion route and add preview endpoint (`server/src/routes/leagues.ts`)
  - [ ] 4.1 Add `GET /api/leagues/:id/deletion-preview` endpoint
  ...
  - [ ] 4.2 Rewrite `DELETE /api/leagues/:id` endpoint
...
- [ ] 5. Update league detail API to include `lockedFromDeletion` field
