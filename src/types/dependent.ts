/**
 * Dependent Account Type Definitions
 *
 * Types for guardian-managed dependent accounts: creation, updates,
 * profile display, and account transfer to independent status.
 *
 * Requirements: 1.1, 4.1, 8.1
 */

import { PlayerSportRating } from './rating';
...
/**
 * Summary view of a dependent, used in list views and the context switcher.
 */
